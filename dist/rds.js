...
class PostgresInstance extends cdk.NestedStack {
    constructor(scope, id, props) {
        ...
        const { stack, instanceType = ec2.InstanceType.of(ec2.InstanceClass.T3, ec2.InstanceSize.MICRO), postgresFullVersion = rds.PostgresEngineVersion.VER_16_4
            .postgresFullVersion, postgresMajorVersion = '16', 
...
class PostgresInstanceWithBastion extends PostgresInstance {
    constructor(scope, id, props) {
        ...
        const keyPair = ec2.KeyPair.fromKeyPairName(this, stack.getResourceID('BastionKeyPairRef'), key.keyName);
